  ...
  return (
    ...
    >
      ...
      <div className='flex flex-wrap justify-center gap-4 text-sm max-sm:text-xs'>
        <button onClick={() => router.push('/ai')} className="bg-primary text-white px-10 py-3 rounded-lg hover:scale-102 
      ...
      <div className="flex items-center gap-4 mt-8 mx-auto text-gray-600">
        <Image src={assets.user_group} alt="users" width={120} height={32} className="h-8 w-auto" />
